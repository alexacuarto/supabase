...
begin
  ...
  insert into auth.users (
    ...
    now(), now(),
    'authenticated', 'authenticated', v_clean_phone, now(),
    '', '', '', '', '', '', ''
  );
  ...
  insert into auth.identities (
    ...
    v_user_id, v_user_id, v_clean_email, 'email',
  ...
  insert into public.profiles (
    id, first_name, last_name, full_name, phone_number, role, email, created_at, updated_at
  ) values (
    v_user_id, v_clean_first, v_clean_last, v_full_name, v_clean_phone, 'admin', v_clean_email, now(), now()
  )
  on conflict (id) do update set
    first_name = excluded.first_name,
    last_name = excluded.last_name,
